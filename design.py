...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.loadImage.setGeometry(QtCore.QRect(310, 10, 141, 31))
        self.loadImage.setObjectName("loadImage")
        self.processImage = QtWidgets.QPushButton(self.centralwidget)
        self.processImage.setGeometry(QtCore.QRect(150, 360, 221, 31))
        ...
        self.infoAboutImage.setEnabled(False)
        self.infoAboutImage.setGeometry(QtCore.QRect(510, 370, 231, 101))
...
"border-color: black;")
        ...
        self.processImage_2 = QtWidgets.QPushButton(self.centralwidget)
        self.processImage_2.setGeometry(QtCore.QRect(150, 400, 221, 31))
        self.processImage_2.setObjectName("processImage_2")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.processImage.setText(_translate("MainWindow", "Process a fingerprint with method 1"))
        ...
        self.processImage_2.setText(_translate("MainWindow", "Process a fingerprint with method 2"))
